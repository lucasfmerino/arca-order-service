    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception
    {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize ->
                {
                    ...
                    // PRODUCT
                    authorize.requestMatchers(HttpMethod.POST, "/api/order/**").hasAnyRole("WEB147", "WEB101");
                    authorize.requestMatchers(HttpMethod.PUT, "/api/order/**").hasAnyRole("WEB147", "WEB101");
